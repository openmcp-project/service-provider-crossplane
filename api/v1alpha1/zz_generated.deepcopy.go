...
func (in *AvailableCrossplaneFunction) DeepCopyInto(out *AvailableCrossplaneFunction) {
	*out = *in
	if in.Versions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailableCrossplaneFunction.
func (in *AvailableCrossplaneFunction) DeepCopy() *AvailableCrossplaneFunction {
	if in == nil {
		return nil
	}
	out := new(AvailableCrossplaneFunction)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrossplaneFunctionConfig) DeepCopyInto(out *CrossplaneFunctionConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrossplaneFunctionConfig.
func (in *CrossplaneFunctionConfig) DeepCopy() *CrossplaneFunctionConfig {
	if in == nil {
		return nil
	}
	out := new(CrossplaneFunctionConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrossplaneFunctions) DeepCopyInto(out *CrossplaneFunctions) {
	*out = *in
	if in.AvailableFunctions != nil {
		in, out := &in.AvailableFunctions, &out.AvailableFunctions
		*out = make([]AvailableCrossplaneFunction, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrossplaneFunctions.
func (in *CrossplaneFunctions) DeepCopy() *CrossplaneFunctions {
	if in == nil {
		return nil
	}
	out := new(CrossplaneFunctions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CrossplaneSpec) DeepCopyInto(out *CrossplaneSpec) {
	*out = *in
	...
	if in.Functions != nil {
		...
		*out = make([]*CrossplaneFunctionConfig, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CrossplaneFunctionConfig)
